...
import vertexShader from './three/vertex.glsl'
import fragmentShader from './three/fragment.glsl'
...
if (about) {
  ...
  const planes = textures.map((element) => {
    ...
    const plane = new THREE.Mesh(new THREE.PlaneGeometry(1, 1, 64, 64), planeMat);
